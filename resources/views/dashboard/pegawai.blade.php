        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 items-start">
            ...
            <div class="xl:col-span-2 space-y-4">
                ...
                <section class="bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-sm">
                    {{-- Header --}}
                    <div
                        class="flex items-center gap-3 px-4 py-3 border-b border-slate-100 bg-gradient-to-r from-indigo-50 to-white">
                    ...
                    <div class="p-4">
                        @php
                            $personalFields = [
                                ...
                                [
                                    ...
                                    'color' => 'text-blue-500',
                                    'label' => 'Email YARSI',
                                    'value' => $pegawai?->email_yarsi ?? '-',
                                ],
                                [
                                    'icon' => 'fa-solid fa-phone',
                                    'color' => 'text-emerald-500',
                                    'label' => 'No. Telepon',
                                    'value' => $pegawai?->no_telpon ?? '-',
                                ],
                            ];
                        @endphp
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                            @foreach ($personalFields as $field)
                                <div class="flex items-start gap-3 rounded-xl bg-slate-50 border border-slate-100 p-3">
                                    <div
                                        class="w-8 h-8 rounded-lg bg-white border border-slate-100 flex items-center justify-center {{ $field['color'] }} shrink-0 mt-0.5">
                                        <i class="{{ $field['icon'] }} text-xs"></i>
                                    </div>
                                    <div class="min-w-0">
                                        <p class="text-[10px] uppercase tracking-wide text-slate-400 font-medium">
                                            {{ $field['label'] }}</p>
                                        <p class="mt-0.5 text-sm font-semibold text-slate-800 leading-relaxed break-words">
                                            {{ $field['value'] }}</p>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mt-2.5">
                            ...
                            <div class="flex items-start gap-3 rounded-xl bg-orange-50 border border-orange-100 p-3">
                                <div
                                    class="w-8 h-8 rounded-lg bg-white border border-orange-100 flex items-center justify-center text-orange-500 shrink-0 mt-0.5">
                                ...
                                <div>
                                    ...
                                    <p class="mt-0.5 text-sm font-semibold text-slate-800 leading-relaxed">
                                        {{ $pegawai?->alamat_ktp ?? '-' }}</p>
                                </div>
                            </div>
                            {{-- Alamat Domisili --}}
                            <div class="flex items-start gap-3 rounded-xl bg-rose-50 border border-rose-100 p-3">
                                <div
                                    class="w-8 h-8 rounded-lg bg-white border border-rose-100 flex items-center justify-center text-rose-500 shrink-0 mt-0.5">
                                    <i class="fa-solid fa-map-location-dot text-xs"></i>
                                </div>
                                <div>
                                    <p class="text-[10px] uppercase tracking-wide text-slate-400 font-medium">Alamat
                                        Domisili</p>
                                    <p class="mt-0.5 text-sm font-semibold text-slate-800 leading-relaxed">
                                        @if ($pegawai?->alamat_domisili && $pegawai?->alamat_domisili !== $pegawai?->alamat_ktp)
                                            {{ $pegawai->alamat_domisili }}
                                        @else
                                            <span class="text-slate-400 font-normal italic text-xs">Sama dengan alamat
                                                KTP</span>
                                        @endif
                                    </p>
                                </div>
                ...
                {{-- ===== DATA KELUARGA ===== --}}
                <section
                    class="bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-sm h-[64vh] flex flex-col">
                    {{-- Header --}}
                    <div
                        ...
                        <div class="flex items-center gap-3 min-w-0">
                            <div
                                class="w-8 h-8 rounded-xl bg-pink-100 text-pink-600 flex items-center justify-center shrink-0">
                        ...
                        {{-- Total --}}
                        <div class="px-2.5 py-1 rounded-lg bg-pink-100 text-pink-700 text-[11px] font-semibold shrink-0">
                                    ...
                                    <tr class="hover:bg-slate-50/70 transition-colors">
                                        ...
                                        <td class="px-3 py-3 align-middle">
                                            ...
                                            <div class="truncate">
                                                ...
                                                @elseif (str_contains($hubungan, 'orang tua') || str_contains($hubungan, 'ayah') || str_contains($hubungan, 'ibu'))
                                                    <span
                                                ...
                                                @elseif (str_contains($hubungan, 'istri') || str_contains($hubungan, 'suami') || str_contains($hubungan, 'pasangan'))
                                                    <span
            ...
            <div class="flex flex-col space-y-4">
                ...
                <section
                    class="flex-1 bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-sm items-start">
                    {{-- Header --}}
                    <div
                        class="flex items-center gap-3 px-4 py-3 border-b border-slate-100 bg-gradient-to-r from-sky-50 to-white">
                    ...
                    <div class="p-4 space-y-2">
                        @php
                            ...
                            $employmentFields = [
                                [
                                    'label' => 'Jabatan',
                                    'value' => $pegawai?->memimpin_unit ? 'Pimpinan' : ($pegawai ? 'Pegawai' : 'N/A'),
                                    'icon' => 'fa-solid fa-id-badge',
                                    'color' => 'text-indigo-500',
                                ],
                                [
                                    'label' => 'Unit Kerja',
                                    'value' => $pegawai?->unit_kerja?->name ?? '-',
                                    'icon' => 'fa-solid fa-sitemap',
                                    'color' => 'text-sky-500',
                                ],
                                [
                                    'label' => 'Tanggal Bergabung',
                                    'value' => $pegawai?->tanggal_bergabung?->translatedFormat('d F Y') ?? '-',
                        ...
                        <div class="flex items-center gap-3 rounded-xl bg-slate-50 border border-slate-100 p-3">
                            <div
                                class="w-7 h-7 rounded-lg bg-white border border-slate-100 flex items-center justify-center text-emerald-500 shrink-0">
                                <i class="fa-solid fa-user-pen text-[11px]"></i>
                            </div>
                            <div class="w-full justify-between">
                                <p class="text-[10px] uppercase tracking-wide text-slate-400 font-medium mb-2">Status
                                    Pegawai</p>
                                <div class="flex items-center justify-between">
                                    <span
                                        class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-semibold border {{ $statusClass }}">
                        ...
                        @foreach ($employmentFields as $ef)
                            <div
                                class="flex items-center gap-3 rounded-xl bg-slate-50 border border-slate-100 px-3 py-2.5">
                                <div
                                    class="w-7 h-7 rounded-lg bg-white border border-slate-100 flex items-center justify-center {{ $ef['color'] }} shrink-0">
                                    <i class="{{ $ef['icon'] }} text-[11px]"></i>
                                </div>
                                <div class="min-w-0 flex-1">
                                    <p class="text-[10px] uppercase tracking-wide text-slate-400 font-medium">
                                        {{ $ef['label'] }}</p>
                                    <p class="mt-0.5 text-xs font-semibold text-slate-800 truncate">{{ $ef['value'] }}
                                    </p>
                                </div>
                            </div>
                        @endforeach
                ...
                <section class="bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-sm">
                    <div
                        class="flex items-center gap-3 px-4 py-3 border-b border-slate-100 bg-gradient-to-r from-cyan-50 to-white">
                    ...
                    <div class="p-4 grid grid-cols-2 gap-2.5">
                        ...
                        <div class="rounded-xl bg-pink-50 border border-pink-100 p-3 text-center">
                            ...
                            <p class="mt-1 text-sm font-bold text-pink-700">
                                {{ $pegawai?->keluarga->count() . ' Orang' ?? 'N/A' }}</p>
                        </div>
                ...
                {{-- ===== DATA REKENING ===== --}}
                <section
                    class="relative bg-gradient-to-br from-indigo-600 via-indigo-700 to-blue-700 rounded-2xl overflow-hidden shadow-lg text-white">
                    {{-- Decorative --}}
                    ...
                    <div class="relative p-4">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <p class="text-[9px] uppercase tracking-[0.2em] text-indigo-200/70 font-medium">Rekening
                                    Payroll</p>
                                <h2 class="mt-0.5 text-sm font-bold">
                                    {{ 'Bank ' . ($pegawai?->rekening?->nama_bank ?? 'Mandiri') }}</h2>
                            </div>
                            <div
                                class="w-9 h-9 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/10">
                                <i class="fa-solid fa-building-columns text-sm"></i>
                            </div>
                        </div>
                        {{-- Card Number --}}
                        <div class="bg-white/10 rounded-xl px-4 py-3 border border-white/10 backdrop-blur-sm">
                            <p class="text-[9px] uppercase tracking-[0.2em] text-indigo-200/70 font-medium mb-1">Nomor
                                Rekening</p>
                        ...
                        <div class="mt-3 flex items-center justify-between gap-2">
                            <div>
                                ...
                                <p class="mt-0.5 text-xs font-semibold">{{ $pegawai?->rekening->nama_rekening ?? 'N/A' }}
                                </p>
                            </div>
