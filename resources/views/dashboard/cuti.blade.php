...
@section('content')
    <div class="flex flex-col bg-white/20 backdrop-blur-sm shadow-md rounded-xl p-4 min-h-[calc(100vh-157px)]">

        <div class="flex justify-between mb-8">
            <div class="flex flex-col gap-2">
                <h1 class="text-2xl font-bold">Cuti</h1>
                <p class="text-sm text-gray-800">Selamat datang di halaman cuti. Di sini Anda dapat melihat dan mengelola
                    informasi cuti Anda.</p>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col gap-4 min-h-0">
            ...
            <div x-data="{
                ...
                {{-- MODAL DELETE CUTI --}}
                <div x-show="showModalDelete" x-transition.opacity
                    class="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm p-4">

                    <!-- Modal Box -->
                    <div @click.away="showModalDelete = false" x-transition.scale
                ...
                {{-- MODAL EDIT CUTI --}}
                <div x-show="showModalEdit" x-transition.opacity
                    class="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm p-4">
                    <!-- Modal Box -->
                    <div @click.away="showModalEdit = false" x-transition.scale
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" value="2026-11-07"
                                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2B76FF] focus:border-transparent transition">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div
                                        class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-[#2B76FF] hover:bg-[#2B76FF]/5 transition cursor-pointer">
...
@section('formCards')
    <div x-data="{
        ...
        <div
            class="bg-[linear-gradient(135deg,_#8187FF_0%,_#7DB5FF_50%,_#D1A6FF_100%)] rounded-[20px] p-8 flex flex-col min-h-24 gap-8 shadow-lg hover:shadow-xl transition">
            <h2
                class="text-[45px] font-bold bg-[linear-gradient(90deg,_#FFA58E_0%,_#DBFFEE_50%,_#70FFEE_100%)] bg-clip-text text-transparent mb-2 max-w-[360px]">
                Form Pengajuan Cuti</h2>
            <button @click="showModalPengajuan = true"
                ...
                <svg width="120" height="20" viewBox="0 0 120 20" fill="none">
                    <defs>
                        <linearGradient id="gradArrow" x1="0" y1="0" x2="120" y2="0"
                    ...
                    <!-- Line -->
                    <line x1="0" y1="10" x2="100" y2="10" stroke="url(#gradArrow)"
                        stroke-width="3" stroke-linecap="round" />
                    <!-- Arrow Head -->
                    <path d="M95 3 L105 10 L95 17" stroke="url(#gradArrow)" stroke-width="3" stroke-linecap="round"
        ...
        <div x-show="showModalPengajuan" x-transition.opacity
            class="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm p-4">
            <!-- Modal Box -->
            <div @click.away="showModalPengajuan = false" x-transition.scale
                class="w-full max-w-2xl max-h-[85vh] bg-white rounded-[20px] shadow-2xl border border-gray-200 flex flex-col">
                <!-- Header -->
                <div
                    class="flex justify-between items-center px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-[#F5F7FA] to-white rounded-t-[20px] flex-shrink-0">
                    ...
                    <button @click="showModalPengajuan = false"
                        class="text-gray-400 hover:text-gray-600 transition cursor-pointer">
                        <i class="fa-solid fa-xmark text-xl"></i>
                    </button>
                </div>
