<div class="bg-white w-[45vw] max-w-[95vw] mx-auto rounded-2xl shadow-2xl flex flex-col overflow-hidden">
    ...
    <div class="px-6 py-5 flex flex-col gap-5">
        ...
        <div>
            ...
            <div class="relative flex items-center justify-center w-full">
                ...
                <label
                    for="dropzone-file"
                    class="group relative flex flex-col items-center justify-center w-full min-h-[220px]
                    rounded-2xl border-2 border-dashed transition-all duration-200 cursor-pointer overflow-hidden
                    ...
                    @else
                        ...
                        <div class="w-full h-full flex flex-col items-center justify-center px-6 py-6 text-center">
                            <div class="w-14 h-14 rounded-2xl bg-white shadow-sm border border-emerald-200 flex items-center justify-center mb-2">
                            ...
                            <div class="max-w-full">
                                ...
                                <button @click="$dispatch('close-import-modal')">
                                    Lihat Preview
                                </button>
                            </div>
    ...
    <footer class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50/60">
        ...
        <button
            ...
            type="button"
            class="flex items-center gap-2 px-5 py-2 text-sm font-semibold text-white rounded-md shadow-sm transition-all cursor-pointer active:scale-95 hover:opacity-90"
