<div class="relative bg-white min-w-2xl min-h-[78vh] mx-auto rounded-2xl shadow-2xl flex flex-col overflow-hidden">
            ...
            <div>
                ...
                <div class="flex items-center gap-2 mt-1 text-sm text-slate-500">
                    <p class="text-xs text-gray-400 mt-0.5">
                        Tambah Data Anggota Keluarga {{ $pegawai->nama }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div class="col-span-2">
                ...
                <input type="text"
                    ...
                    wire:model.live.debounce.500ms="form.nama" placeholder="cth: Budiono Siregar">
                @error('form.nama')
    ...
    <div class="flex justify-end gap-3 p-4 border-t border-gray-200">
        ...
        <button type="button"
            ...
            @disabled(blank($form['nama']) || blank($form['tanggal_lahir']) || blank($form['jenis_keluarga_id']) || $errors->any()) wire:loading.attr="disabled" wire:target="save"
