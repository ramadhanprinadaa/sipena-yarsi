<div class="flex flex-col space-y-6 h-[calc(100vh-300px)]">
    <!-- Header -->
    <div
        ...
        <div class="table-wrapper">
            @if ($this->pendidikan->isEmpty())
                ...
                <div class="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <h4 class="text-base font-semibold text-slate-700">Data Riwayat Pendidikan Belum Tersedia</h4>
                    <p class="text-sm text-gray-500 mt-1 max-w-base">
