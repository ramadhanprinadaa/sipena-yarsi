<div class="space-y-6">
    <div class="flex items-center justify-between bg-white rounded-md shadow-md border border-indigo-100 p-5">
        ...
        <button class="px-4 py-2 text-sm font-medium bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-600 hover:text-white transition-colors duration-200 shadow-sm">
