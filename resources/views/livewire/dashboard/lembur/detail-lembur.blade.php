                    ...
                    <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" readonly
                                        value="{{ $selectedLembur?->suratPerintahLembur?->nomor_surat }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" readonly
                                        value="{{ $selectedLembur?->suratPerintahLembur?->unitKerja?->name }}"
                                        class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2B76FF] focus:border-transparent pointer-events-none  transition">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-4 border-t border-gray-200">
                            ...
                            @if ($selectedLembur?->laporanHasilLembur)
                                <div>
                                    <label class="block text-xs font-semibold text-gray-700 mb-2">Hasil
                                        Pekerjaan</label>
                                    <textarea readonly
