            ...
            <div x-data="{
                ...
                @if (in_array('riwayat', $allowedTabs))
                    <div x-show="activeTab === 'riwayat'" class="flex flex-col space-y-4 h-full min-h-0">
                        ...
                        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between text-gray-500">
                            ...
                            <!-- Search -->
                            <div
                                class="flex items-center w-full md:w-72 border border-gray-200 rounded-[10px] bg-white px-3">
                        ...
                        <!-- Table -->
                        <div
                            class="flex flex-col flex-1 min-h-0 overflow-hidden bg-[#F5F7FA]/50 border border-gray-200 rounded-[20px] shadow-sm">
                                    ...
                                    <tbody class="divide-y divide-[#878787]/30">
                                        <tr class="hover:bg-[#F5F7FA]/50 transition">
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                <span
                                                    class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold">Disetujui</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div x-show="activeTab === 'rekap'" class="flex flex-col space-y-4 h-full min-h-0">
                        ...
                        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between text-gray-500">
                            ...
                            <div class="relative w-48">
                                <!-- Icon -->
                                <i
                                    class="fa-regular fa-calendar text-[16px] absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 text-sm"></i>
                                <!-- Input -->
                                <input type="text" id="dateRange" placeholder="Periode Cut Off"
                        ...
                        <div
                            ...
                            <div class="flex-1 overflow-y-auto no-scrollbar">
                                <table class="min-w-full text-sm">
                                    <!-- Header -->
                                    <thead
                                        class="bg-[#F5F7FA] text-gray-600 text-xs uppercase tracking-wider sticky top-0">
                                        <tr>
                                            <th class="px-4 py-3 text-left font-semibold">Nama Pegawai</th>
                ...
                @if (in_array('verifikasi', $allowedTabs))
                                ...
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody class="divide-y divide-[#878787]/30">
                                        <tr class="hover:bg-[#F5F7FA]/50 transition">
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                <button
                                                    class="px-3 py-1.5 text-xs font-medium text-blue-500 border border-blue-500 rounded-[10px] hover:bg-blue-600/10 transition cursor-pointer">
                                                    Setujui
                                                </button>
                                                <button
                                                    class="px-3 py-1.5 text-xs font-medium text-red-500 border border-red-500 rounded-[10px] hover:bg-red-600/10 transition cursor-pointer">
                                                    Tolak
                                                </button>
                                            </td>
                                        </tr>
                    ...
                    <div x-show="showModal" x-transition.opacity
                        ...
                        <!-- Modal Box -->
                        <div @click.away="showModal = false" x-transition.scale
                            class="w-full max-w-4xl max-h-[80vh] bg-white rounded-[20px] shadow-2xl border border-gray-200 flex flex-col">
                            <!-- Header -->
                            <div
                                class="flex justify-between items-center px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-[#F5F7FA] to-white rounded-t-[20px] flex-shrink-0">
                            ...
                            <!-- Content Scrollable -->
                            <div
                                class="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#2B76FF]/50 scrollbar-track-gray-100">
                                <div class="p-6 space-y-6">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 mb-4 pb-3 border-b-2 border-[#2B76FF]">
                                            ...
                                            <p class="text-xs font-bold text-[#2B76FF] uppercase tracking-wide">Informasi
                                                Surat</p>
                                        </div>
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-xs font-semibold text-gray-700 mb-2">Nomor
                                                    Surat</label>
                                            ...
                                            <div>
                                                <label class="block text-xs font-semibold text-gray-700 mb-2">Unit
                                                    Kerja</label>
                                        ...
                                        <div class="mt-4">
                                            <label class="block text-xs font-semibold text-gray-700 mb-2">Tanggal
                                                Dibuat</label>
                                            <input type="date"
                                                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2B76FF] focus:border-transparent transition">
                                        </div>
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                        <div class="flex items-center gap-2 mb-4 pb-3 border-b-2 border-[#2B76FF]">
                                            <div class="w-1 h-5 bg-[#2B76FF] rounded-full"></div>
                                            <p class="text-xs font-bold text-[#2B76FF] uppercase tracking-wide">Detail
                                                Kegiatan</p>
                                        </div>
                                        <div>
                                            <label class="block text-xs font-semibold text-gray-700 mb-2">Nama
                                                Kegiatan</label>
                                        ...
                                        <div>
                                            <label class="block text-xs font-semibold text-gray-700 mb-2">Deskripsi
                                                Tugas</label>
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                        <div class="flex items-center gap-2 mb-4 pb-3 border-b-2 border-[#2B76FF]">
                                            <div class="w-1 h-5 bg-[#2B76FF] rounded-full"></div>
                                            <p class="text-xs font-bold text-[#2B76FF] uppercase tracking-wide">Waktu
                                                Lembur</p>
                                        </div>
                                        <div class="grid grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                <label class="block text-xs font-semibold text-gray-700 mb-2">Jam
                                                    Mulai</label>
                                                <input type="time"
                                                    class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2B76FF] focus:border-transparent transition">
                                            </div>
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                        <div class="flex items-center gap-2 mb-4 pb-3 border-b-2 border-[#2B76FF]">
                                            <div class="w-1 h-5 bg-[#2B76FF] rounded-full"></div>
                                            <p class="text-xs font-bold text-[#2B76FF] uppercase tracking-wide">Pilih
                                                Pegawai</p>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <div
                                                class="flex items-center border border-gray-300 rounded-lg px-3 bg-white focus-within:ring-2 focus-within:ring-[#2B76FF] focus-within:border-transparent transition">
                                        ...
                                        <!-- Pegawai Table -->
                                        <div
                                            class="border border-gray-200 rounded-lg overflow-hidden max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-[#2B76FF]/50 scrollbar-track-gray-100">
                                            <table class="w-full text-sm">
                                                <!-- Header -->
                                                <thead class="bg-[#F5F7FA] sticky top-0 z-10">
                                                    <tr class="border-b border-gray-200">
                                                        <th
                                                            class="px-4 py-3 text-left font-bold text-gray-700 text-xs uppercase tracking-wider">
                                                            Nama Pegawai</th>
                                                        <th
                                                            class="px-4 py-3 text-left font-bold text-gray-700 text-xs uppercase tracking-wider">
                                                            NIP</th>
                                                        <th
                                                            ...
                                                            Jabatan</th>
                                                        <th
                                                            class="px-4 py-3 text-center font-bold text-gray-700 text-xs uppercase tracking-wider">
                                                            Aksi</th>
                                                    </tr>
                                                </thead>
                                                <!-- Body -->
                                                <tbody class="divide-y divide-gray-200">
                                                    <tr class="hover:bg-blue-50 transition cursor-pointer">
                                                        <td class="px-4 py-3 font-semibold text-gray-800">Rafly Eryan Azis
                                                        </td>
                                                        <td class="px-4 py-3 text-gray-600">198804212015031002</td>
                                                        <td class="px-4 py-3 text-gray-600">Dekan</td>
                                                        <td class="px-4 py-3 text-center">
                                                            <button
                                                                class="p-1.5 text-[#2B76FF] hover:bg-blue-100 rounded-lg transition">
