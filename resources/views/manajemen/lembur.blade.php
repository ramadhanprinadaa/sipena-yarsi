            ...
            class="flex flex-col gap-4 min-h-0">
                ...
                <div x-show="activeTab === 'spl'" class="flex flex-col space-y-4 h-full min-h-0">
                    ...
                    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between text-gray-500">
                        ...
                        <!-- Button -->
                        <button @click="showModal = true" class="flex items-center w-48 h-10 justify-center cursor-pointer bg-[#2B76FF] hover:shadow-lg text-white text-sm rounded-[10px] transition">
                                ...
                                <tbody class="divide-y divide-[#878787]/30">
                                    <tr class="hover:bg-[#F5F7FA]/50 transition">
                                        ...
                                        <td class="px-4 py-4 text-center">
                                            <button @click="showEditModal = true" class="px-3 py-1.5 text-xs font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition cursor-pointer">
                                                Edit
                                            </button>
                                        </td>
                                    </tr>
                        ...
                        <div class="flex-1 overflow-y-auto no-scrollbar">
                            <table class="min-w-full text-sm">
                                ...
                                <tbody class="divide-y divide-[#878787]/30">
                                    <tr class="hover:bg-[#F5F7FA]/50 transition">
                                        <td class="px-4 py-4 font-medium text-gray-700">John Doe</td>
                                        <td class="px-4 py-4 text-gray-600">30 April 2026 | 18:00 - 21:00</td>
                                        <td class="px-4 py-4 text-gray-600">Mengerjakan dokumentasi sistem</td>
                                        <td class="px-4 py-4 text-center">
                                            <button class="px-3 py-1.5 text-xs font-medium text-blue-500 border border-blue-500 rounded-[10px] hover:bg-blue-600/10 transition cursor-pointer">
                                                Setujui
                                            </button>
                            ...
                            <div class="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#2B76FF]/50 scrollbar-track-gray-100">
                                <div class="p-6 space-y-6">
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                                ...
                                                <tbody class="divide-y divide-gray-200">
                                                    <tr class="hover:bg-blue-50 transition cursor-pointer">
                                                        ...
                                                        <td class="px-4 py-3 text-center">
                                                            <button @click="toggleEmployeeSelection({ name: 'Rafly Eryan Azis', nip: '198804212015031002', jabatan: 'Dekan' })" 
                                                                class="p-1.5 rounded-lg transition cursor-pointer"
                                                                :class="isEmployeeSelected('198804212015031002') ? 'text-white bg-[#2B76FF]' : 'text-[#2B76FF] hover:bg-blue-100'">
                                                                <i class="fa-solid fa-check text-sm"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    <tr class="hover:bg-blue-50 transition cursor-pointer">
                                                        <td class="px-4 py-3 font-semibold text-gray-800">John Doe</td>
                                                        <td class="px-4 py-3 text-gray-600">198804212015031003</td>
                                                        <td class="px-4 py-3 text-gray-600">Dosen</td>
                                                        <td class="px-4 py-3 text-center">
                                                            <button @click="toggleEmployeeSelection({ name: 'John Doe', nip: '198804212015031003', jabatan: 'Dosen' })" 
                                                                class="p-1.5 rounded-lg transition cursor-pointer"
                                                                :class="isEmployeeSelected('198804212015031003') ? 'text-white bg-[#2B76FF]' : 'text-[#2B76FF] hover:bg-blue-100'">
                                                                <i class="fa-solid fa-check text-sm"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    <tr class="hover:bg-blue-50 transition cursor-pointer">
                                                        <td class="px-4 py-3 font-semibold text-gray-800">Jane Smith</td>
                                                        <td class="px-4 py-3 text-gray-600">198804212015031004</td>
                                                        <td class="px-4 py-3 text-gray-600">Staff</td>
                                                        <td class="px-4 py-3 text-center">
                                                            <button @click="toggleEmployeeSelection({ name: 'Jane Smith', nip: '198804212015031004', jabatan: 'Staff' })" 
                                                                class="p-1.5 rounded-lg transition cursor-pointer"
                                                                :class="isEmployeeSelected('198804212015031004') ? 'text-white bg-[#2B76FF]' : 'text-[#2B76FF] hover:bg-blue-100'">
                                                                <i class="fa-solid fa-check text-sm"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    <tr class="hover:bg-blue-50 transition cursor-pointer">
                                                        <td class="px-4 py-3 font-semibold text-gray-800">Bob Johnson</td>
                                                        <td class="px-4 py-3 text-gray-600">198804212015031005</td>
                                                        <td class="px-4 py-3 text-gray-600">Tendik</td>
                                                        <td class="px-4 py-3 text-center">
                                                            <button @click="toggleEmployeeSelection({ name: 'Bob Johnson', nip: '198804212015031005', jabatan: 'Tendik' })" 
                                                                class="p-1.5 rounded-lg transition cursor-pointer"
                                                                :class="isEmployeeSelected('198804212015031005') ? 'text-white bg-[#2B76FF]' : 'text-[#2B76FF] hover:bg-blue-100'">
                                                                <i class="fa-solid fa-check text-sm"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div x-show="selectedEmployees.length > 0" class="mt-4">
                                            <div class="flex items-center gap-2 mb-3 pb-2 border-b-2 border-[#2B76FF]">
                                                <div class="w-1 h-5 bg-[#2B76FF] rounded-full"></div>
                                                <p class="text-xs font-bold text-[#2B76FF] uppercase tracking-wide">Pegawai Terpilih (<span x-text="selectedEmployees.length"></span>)</p>
                                            </div>
                                            <div class="space-y-2 max-h-40 overflow-y-auto scrollbar-thin scrollbar-thumb-[#2B76FF]/50 scrollbar-track-gray-100">
                                                <template x-for="(employee, index) in selectedEmployees" :key="employee.nip">
                                                    <div class="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-lg px-3 py-2">
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <p class="text-sm font-semibold text-gray-800" x-text="employee.name"></p>
                                                                <p class="text-xs text-gray-600" x-text="employee.nip + ' - ' + employee.jabatan"></p>
                                                            </div>
                                                        </div>
                                                        <button @click="selectedEmployees.splice(index, 1)" 
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="flex justify-between items-center px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-[#F5F7FA] to-white rounded-t-[20px] flex-shrink-0">
                                ...
                                <button @click="showEditModal = false" class="text-gray-400 hover:text-gray-600 cursor-pointer transition">
                                    <i class="fa-solid fa-xmark text-xl"></i>
                                </button>
                            </div>
                                ...
                                <div class="p-6 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-xs font-semibold text-gray-700 mb-2">Nomor Surat</label>
                                                <input type="text" value="SPL/2023/X/089"
                                                    class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2B76FF] focus:border-transparent transition">
                                            </div>
                                            <div>
                                                <label class="block text-xs font-semibold text-gray-700 mb-2">Unit Kerja</label>
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                        ...
                                        <div>
                                            <label class="block text-xs font-semibold text-gray-700 mb-2">Nama Kegiatan</label>
                                            <input type="text" value="Contoh: Menyelesaikan Fitur SIPENA"
                                                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2B76FF] focus:border-transparent transition mb-4">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-semibold text-gray-700 mb-2">Deskripsi Tugas</label>
